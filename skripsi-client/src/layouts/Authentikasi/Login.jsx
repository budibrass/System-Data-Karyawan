...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    .then((resp) => {
      ...
      swal("Pemberitahuan", "Selamat datang di Sistem Informasi Aksaramaya", "success");
      if(resp.data.token) {
    ...
    .catch((err) => {
      swal("Error", "Maaf email atau password yang anda masukkan salah", "error");
        ...
        <div className="authentication-inner">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <h4 className="mb-2">Selamat datang di Aksaramaya 👋</h4>
              <p className="mb-4">Silahkan login untuk mengakses web apps</p>
              ...
              <form id="formAuthentication" className="mb-3" onSubmit={handleLogin}>
                ...
                <div className="mb-3">
                  {/* <div className="form-check">
                    ...
                    <label className="form-check-label" for="remember-me"> Ingat saya</label>
                  </div> */}
                </div>
                <div className="mb-3">
